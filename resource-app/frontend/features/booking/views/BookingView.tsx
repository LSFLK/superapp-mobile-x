            ...
            <section>
              ...
              <div className="mb-4 bg-white p-3 rounded-xl border border-slate-100 shadow-sm">
                <div className="flex justify-between text-[10px] text-slate-400 mb-2 font-medium uppercase">
                  {Array.from({ length: (APP_CONFIG.VISUAL_END_HOUR - APP_CONFIG.VISUAL_START_HOUR) / 4 + 1 }, (_, i) => APP_CONFIG.VISUAL_START_HOUR + i * 4).map(hour => (
              ...
              <div className="flex gap-3">
                <div className="relative flex-1">
                  <Input
                    ...
                    className={cn(
                      "h-14 text-xl font-bold tracking-wide text-center w-full bg-transparent",
                  ...
                  />
                  {!startTime && (
                    <span className="absolute inset-0 flex items-center justify-center text-sm text-slate-400 pointer-events-none">Tap here to select time</span>
                  )}
                </div>
              </div>
